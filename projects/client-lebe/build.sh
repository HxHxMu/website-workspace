...
for page in src/index.html src/cart.html src/privacy.html src/terms.html src/shipping.html src/returns.html src/size-guide.html src/care.html src/contact.html src/order-issue.html src/404.html src/products-feed.xml; do
  if [ ! -f "$page" ]; then
