...
const policies = [
  {
    ...
    sections: [
      ...
      },
      {
        heading: 'Contact.',
        body: [
          'For privacy-related questions, use the <a href="/contact">contact form</a>. We reply by email from our LEBE support inbox.',
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: 'Questions.',
        body: [
          'For general shipping questions, use the <a href="/contact">contact form</a>. We reply by email from our LEBE support inbox.',
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: 'Contact.',
        body: [
          'For damaged, defective, incorrect, or missing orders, use the <a href="/order-issue">order issue form</a>. For general questions, use the <a href="/contact">contact form</a>. We reply by email from our LEBE support inbox.',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: 'Contact.',
        body: [
          'Questions regarding these terms may be sent through the <a href="/contact">contact form</a>. We reply by email from our LEBE support inbox.',
        ],
      },
    ],
  }
